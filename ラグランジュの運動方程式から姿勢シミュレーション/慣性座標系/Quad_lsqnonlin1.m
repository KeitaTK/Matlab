...
m = 1.36; g = 9.81;
% 　調節するパラメータの初期値を入れる。
J_xx = 0.008; J_yy = 0.005; J_zz = 0.005; 
...
params_estimated = lsqnonlin(@(params) objective_function(params, tspan, Current0, setting_val, const, fdX, fR_BtoI, fOmega, fP_BtoI, fP_ItoB, time_csv, motor_val_csv, real_time, real_att), params0,[],[],options);
disp('最適化前のパラメータ');
disp(params0);
disp('最適化した後のパラメータ ');
...
[ta, Current] = ode45(@(t, Current) system_dynamics(t, Current, const_optimized, setting_val, fdX, fR_BtoI, fOmega, fP_BtoI, fP_ItoB, time_csv, motor_val_csv), tspan, Current0,options);
...
function error = objective_function(params, tspan, Current0, setting_val, const, fdX, fR_BtoI, fOmega, fP_BtoI, fP_ItoB, time_csv, motor_val_csv, real_time, real_att)
